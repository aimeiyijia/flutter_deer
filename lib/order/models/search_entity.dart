...
import 'package:manager_app/generated/json/search_entity.g.dart';
...
class SearchItemsOwner {
  ...
  factory SearchItemsOwner.fromJson(Map<String, dynamic> json) =>
      $SearchItemsOwnerFromJson(json);
...
class SearchItemsLicense {
  ...
  factory SearchItemsLicense.fromJson(Map<String, dynamic> json) =>
      $SearchItemsLicenseFromJson(json);
